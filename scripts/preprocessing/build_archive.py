"""Build parcellated_data_MC.zip with all timeseries and dataset description."""
...
TS   = BASE / "timeseries"
OUT  = BASE / "parcellated_data_MC.zip"
...
# ── Dataset description ───────────────────────────────────────────────────────
desc = {
    "Name": "AD Motion-Corrected fMRI Parcel Timeseries",
    "Date": str(date.today()),
    "Description": (
    ...
    "Preprocessing": {
        ...
        "confounds": "24 HMP (6 params + derivatives + quadratics) + CSF + WM + derivatives",
