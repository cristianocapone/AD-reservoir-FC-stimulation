% ============================================================================
%  Nature Communications â€” manuscript (single-column, submission format)
%  Reservoir-computing readout geometry & in-silico stimulation in AD fMRI
%
%  Compile:  pdflatex main ; bibtex main ; pdflatex main ; pdflatex main
%  Primary target: Nature Communications. NC accepts LaTeX at submission;
%  this emulates the house style (superscript citations, naturemag reference
%  list, Methods before Results per Brain, double spacing + line numbers) in the
%  standard article class rather than the Springer-Nature sn-jnl class, for
%  portability. Secondary target (Scientific Reports) is the same Nature
%  Portfolio style, so only the heading styling would differ.
% ============================================================================
...
\usepackage{setspace}
\doublespacing                         % Nature Communications submission spacing
...
\emph{personalised} LDA-resonant target moves essentially all AD-side patients across the boundary (Supplementary Methods). The single-site reclassification is therefore a
