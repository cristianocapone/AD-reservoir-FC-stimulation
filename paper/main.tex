...
%  Nature Communications accepts LaTeX at submission; this emulates the
%  house style (superscript citations, naturemag reference list, Methods
%  after Discussion, double spacing + line numbers) in the standard article
%  class rather than the Springer-Nature sn-jnl class, for portability.
% ============================================================================
...
\usepackage{booktabs}
\usepackage{siunitx}
\usepackage{caption}                          % Nature-style "Fig. 1 |" captions
...
\usepackage[super,sort&compress]{natbib}      % superscript citations (Nature style)
