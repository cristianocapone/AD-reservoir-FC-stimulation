...
Resting-state functional MRI sessions were drawn from cognitively unimpaired
controls (CC) and patients with Alzheimer's disease (AD). Each session
...
\todo{Add data/code availability, exact $N$, and any ethics/consent statement.}

% ============================================================================
\clearpage
% , , , , , , , , , , , , , , , , , , , , , , , , , --
%  References (BibTeX).  All entries live in refs.bib.
%  \nocite{*} prints every entry in refs.bib so the full thematic bibliography
%  is visible during drafting; REMOVE \nocite{*} before submission so that only
%  cited works appear, and replace unsrtnat with the journal style (e.g. Science).
