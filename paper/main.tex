...
site, with a real-time closed-loop controller reaching nearly the same efficacy at
substantially lower dose using only causally available information. The
...
\begin{figure}[tbp]
  ...
  future trajectory (Materials and Methods).
